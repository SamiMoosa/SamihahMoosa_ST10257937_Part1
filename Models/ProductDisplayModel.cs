...
namespace NewApp.Models
{
    public class ProductDisplayModel
    {
        ...
        public static List<ProductDisplayModel> SelectProducts()
        {
            ...
            string con_string = "Server=tcp:sami-sql-server.database.windows.net,1433;Initial Catalog=sami-DB;Persist Security Info=False;User ID=samimoosa;Password=Ilovecapetown2410;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30";
